...
const Warface: React.FC = () => {
  ...
  const loadLoadouts = async () => {
    try {
      const data = await weaponLoadoutsService.getByCategory(slug || 'delta-force', 'warface')
      setLoadouts(data)
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          <h1 className="text-4xl font-bold">Warface Loadouts</h1>
          <div className="flex-1 h-[1px] bg-gray-700"></div>
        </div>
        <p className="text-gray-400">Các build súng tối ưu cho Warface mode</p>
      </div>
